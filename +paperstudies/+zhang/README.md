# Zhang paper-study API

공개 initial conditions, aerodynamic expressions, RAAP/BZC와 equation checks를 제공한다. Optimal control solver와 flight trajectory reproduction은 포함하지 않는다.
